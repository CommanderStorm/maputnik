...
export default class App extends React.Component<any, AppState> {
	...
	updateIcons(baseUrl: string) {
		// Load sprite names for backward compatibility
		downloadSpriteMetadata(baseUrl, (icons) => {
			this.setState({ spec: updateRootSpec(this.state.spec, "sprite", icons) });
		});

		// Load sprite data with images for visual preview
		downloadSpriteData(baseUrl, (spriteData: SpriteData[]) => {
			this.setState({
				spec: updateRootSpec(this.state.spec, "spriteData", spriteData),
			});
		});
	}
